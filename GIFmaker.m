...
% Hints: get(hObject,'String') returns contents of dir1 as text
%        str2double(get(hObject,'String')) returns contents of dir1 as a double
...
% Hints: get(hObject,'String') returns contents of dir2 as text
%        str2double(get(hObject,'String')) returns contents of dir2 as a double
...
% Hints: get(hObject,'String') returns contents of dir3 as text
%        str2double(get(hObject,'String')) returns contents of dir3 as a double
...
% Hints: get(hObject,'String') returns contents of dir4 as text
%        str2double(get(hObject,'String')) returns contents of dir4 as a double
